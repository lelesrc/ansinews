...
const { normalizeConfig, parseRSS, VERSION, setDefaultFeeds, normalizeCatalog } = require('./ansinews-core.js');
...
// ---------------------------------------------------------------------------
// Config I/O (same paths and priority as terminal.js)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// HTTP fetch (same pattern as terminal.js)
// ---------------------------------------------------------------------------
