...
2. Test the terminal shell: `node news.js` — navigate, filter, refresh, open detail view.
...
```
news-core.js    shared core (feeds, parsing, state, commands)
news.js         terminal shell (ANSI rendering, keyboard, file I/O)
browser.js      browser shell (DOM rendering, localStorage, clicks)
index.html      browser container and CSS
```

- Shared behavior belongs in `news-core.js`.
